...
public class groupMessageAdapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<groupMsgModelclass> groupmessagesAdpterArrayList;
    int ITEM_SEND=1;
    int ITEM_RECIVE=2;

    public groupMessageAdapter(Context context, ArrayList<groupMsgModelclass> messagesAdpterArrayList) {
        this.context = context;
        this.groupmessagesAdpterArrayList = messagesAdpterArrayList;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        groupMsgModelclass messages = groupmessagesAdpterArrayList.get(position);
    ...
    public int getItemCount() {
        return groupmessagesAdpterArrayList.size();
    }
